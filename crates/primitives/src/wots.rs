...
impl From<strata_bridge_p2p_types::Wots256PublicKey> for Wots256PublicKey {
    fn from(value: strata_bridge_p2p_types::Wots256PublicKey) -> Self {
        Self(Arc::new(value.0))
    }
}

impl From<Wots256PublicKey> for strata_bridge_p2p_types::Wots256PublicKey {
    fn from(value: Wots256PublicKey) -> Self {
        strata_bridge_p2p_types::Wots256PublicKey::new(*value.0)
    }
}
...
impl From<strata_bridge_p2p_types::Wots128PublicKey> for WotsHashPublicKey {
    fn from(value: strata_bridge_p2p_types::Wots128PublicKey) -> Self {
        Self(value.0)
    }
}

impl From<WotsHashPublicKey> for strata_bridge_p2p_types::Wots128PublicKey {
    fn from(value: WotsHashPublicKey) -> Self {
        strata_bridge_p2p_types::Wots128PublicKey::new(value.0)
    }
}
...
impl TryFrom<strata_bridge_p2p_types::Groth16PublicKeys> for Groth16PublicKeys {
    type Error = (String, strata_bridge_p2p_types::Groth16PublicKeys);

    fn try_from(g16_keys: strata_bridge_p2p_types::Groth16PublicKeys) -> Result<Self, Self::Error> {
...
impl From<Groth16PublicKeys> for strata_bridge_p2p_types::Groth16PublicKeys {
    fn from(value: Groth16PublicKeys) -> Self {
        let (public_inputs, fqs, hashes) = *value.0;

        Self::new(
            public_inputs
                .map(strata_bridge_p2p_types::Wots256PublicKey::new)
                .into_iter()
                .collect(),
            fqs.map(strata_bridge_p2p_types::Wots256PublicKey::new)
                .into_iter()
                .collect(),
            hashes
                .map(strata_bridge_p2p_types::Wots128PublicKey::new)
                .into_iter()
                .collect(),
        )
    }
...
impl TryFrom<strata_bridge_p2p_types::WotsPublicKeys> for PublicKeys {
    type Error = (String, strata_bridge_p2p_types::WotsPublicKeys);

    fn try_from(value: strata_bridge_p2p_types::WotsPublicKeys) -> Result<Self, Self::Error> {
        let groth16 = value.groth16.try_into().map_err(
            |e: (String, strata_bridge_p2p_types::Groth16PublicKeys)| {
                (
                    e.0,
                    WotsPublicKeys {
...
impl From<PublicKeys> for strata_bridge_p2p_types::WotsPublicKeys {
