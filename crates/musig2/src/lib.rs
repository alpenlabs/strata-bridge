...
pub mod adaptor {
    pub use crate::{
        bip340::{sign_solo_adaptor as sign_solo, verify_single_adaptor as verify_single},
        sig_agg::aggregate_partial_adaptor_signatures as aggregate_partial_signatures,
        signature::AdaptorSignature,
        signing::{sign_partial_adaptor as sign_partial, verify_partial_adaptor as verify_partial},
    };
}
