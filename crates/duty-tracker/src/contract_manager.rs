        ...
        task::spawn(async move {
            ...
            loop {
                ...
                tokio::select! {
                    ...
                    // First prioritize our own outbound messages to ensure that our state is
                    // as consistent as possible with our peers' state.
                    ...
                    // Then prioritize synthetic events to ensure we are doing everything we need
                    // to fully process external events prior to processing additional external
                    // events.
                    ...
                    // Finally process peer messages. We do this last so we have the best chance of
                    ...
                    // Nag for things we need in our downtime only.
                    _ = interval.tick() => {
                        let nags = ctx.nag();
                        for nag in nags {
