...
/// Builds the bridge-counterproof genesis from the bridge-proof guest's genesis and predicate key.
pub fn load_genesis_from_bridge_genesis(
...
pub fn load_genesis_from_predicate(bridge_proof_vk: PredicateKey) -> BridgeCounterproofGenesis {
    load_genesis_from_bridge_genesis(bridge_proof_vk, load_bridge_proof_genesis_from_env())
}
