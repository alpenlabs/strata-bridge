...
pub fn header_verification_state() -> HeaderVerificationState {
    let mut timestamps = [
        1742914926, 1742914926, 1742914930, 1742914930, 1742914930, 1742914930, 1742914934,
        1742914934, 1742914934, 1742914934, 1742914938,
    ];
    timestamps.sort();

    HeaderVerificationState {
        last_verified_block_num: 1880,
        last_verified_block_hash: L1BlockId::from(
            Buf32::try_from_slice(
                &hex::decode("6cf70b57bd1be7e63430e0fe954408e5355e1a4eb40c770c19509d56265a2a64")
                    .unwrap(),
            )
            .unwrap(),
        ),
        ...
        last_11_blocks_timestamps: TimestampStore::new_with_head(timestamps, 0),
    }
}
