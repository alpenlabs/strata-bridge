...
pub enum ServerMessage {
    ...
    OperatorPubkey {
        /// Serialized [`PublicKey`](bitcoin::PublicKey) for operator authentication.
        pubkey: [u8; 33],
    },
    ...
    P2PPubkey {
        /// Serialized [`PublicKey`](bitcoin::PublicKey) for P2P authentication.
        pubkey: [u8; 33],
    },
    ...
    Musig2Pubkey {
        /// Serialized [`PublicKey`](bitcoin::PublicKey) for MuSig2 authentication.
        pubkey: [u8; 33],
    },
    ...
    Musig2FirstRoundHoldouts {
        /// Serialized [`PublicKey`](bitcoin::PublicKey)s of signers whose public nonces
    ...
    Musig2SecondRoundHoldouts {
        /// Serialized [`PublicKey`](bitcoin::PublicKey)s of signers whose partial signatures
        /// the server does not have for this signing session.
        pubkeys: Vec<[u8; 33]>,
    },
...
pub enum ClientMessage {
    ...
    Musig2NewSession {
        /// [`PublicKey`](bitcoin::PublicKey)s for the signing session.
        ///
        /// # Warnings
        ///
        /// May or may not include the
        /// client's own public key. If not present, it should be added. May or may not be
        /// sorted.
        pubkeys: Vec<[u8; 33]>,
    ...
    Musig2FirstRoundReceivePubNonce {
        ...
        /// The serialized [`PublicKey`](bitcoin::PublicKey) of the signer whose pubnonce this is.
        pubkey: [u8; 33],
    ...
    Musig2SecondRoundReceiveSignature {
        ...
        /// That signer's MuSig2 partial signature without the nonce.
        signature: [u8; 32],
    },
