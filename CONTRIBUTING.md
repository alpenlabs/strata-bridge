...
> then it must be disclosed in the pull request description.

> [!WARNING]
> You must write commit descriptions and pull request descriptions **yourself**.
> You may **not** use AI to generate these descriptions.

Be specific what AI was for used and for which commits.

Examples:

> Commit 98e2f3aec32c65199ee60f182897379e6c08d6d0 was mainly written by AI.

> The test cases in commit 98e2f3aec32c65199ee60f182897379e6c08d6d0 are AI-generated.

If AI was used for most commits, then you can generalize.
You don't have to list each commit hash.

Examples:

> I used AI to generate the documentation.

> The test cases were generated by AI.

> The implementation was initially written by AI.
> I checked each line and refactored to code here and there.

> [!NOTE]
>
> You don't need to disclose tab completion,
> so long as it is limited to single keywords or short phrases.

Failure to disclose AI usage is impolite to the human reviewers
on the other end of the pull request. It also makes it difficult to
