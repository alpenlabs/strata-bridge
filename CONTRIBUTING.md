...
> [!IMPORTANT]
>
> If you are using **any kind of AI assistance** in your contribution,
> then it must be disclosed in the description.
...
on the other end. It also makes it difficult to determine how much
scrutiny to apply to the contribution.
...
> I checked each line and refactored the code here and there.
